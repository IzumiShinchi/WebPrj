...
public class ContentsController {
	...
	public ModelAndView openKmovie() throws Exception {
		...
		List<ContentsFileDTO> filelist = contentsService.kMovieContentsFileList();
		mv.addObject("list", list);
		mv.addObject("filelist", filelist);
		return mv;
	}
	...
	public ModelAndView openFmovie() throws Exception {
		...
		List<ContentsFileDTO> filelist = contentsService.fMovieContentsFileList();
		mv.addObject("list", list);
		mv.addObject("filelist", filelist);
		return mv;
	}
	...
	public ModelAndView openTani() throws Exception {
		...
		List<ContentsFileDTO> filelist = contentsService.tAniContentsFileList();
		mv.addObject("list", list);
		mv.addObject("filelist", filelist);
		return mv;
	}
	...
	public ModelAndView openKdrama() throws Exception {
		...
		List<ContentsFileDTO> filelist = contentsService.kDramaContentsFileList();
		mv.addObject("list", list);
		mv.addObject("filelist", filelist);
		return mv;
	} 
	...
	public ModelAndView openFdrama() throws Exception {
		...
		List<ContentsFileDTO> filelist = contentsService.fDramaContentsFileList();
		mv.addObject("list", list);
		mv.addObject("filelist", filelist);
		return mv;
	}
