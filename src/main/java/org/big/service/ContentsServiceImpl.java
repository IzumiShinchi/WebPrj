...
public class ContentsServiceImpl implements ContentsService {
	...
	@Override
	public List<ContentsFileDTO> fMovieContentsFileList() throws Exception {
		return contentsMapper.fMovieContentsFileList();
	};
	
	@Override
	public List<ContentsFileDTO> kMovieContentsFileList() throws Exception {
		return contentsMapper.kMovieContentsFileList();
	};
	
	@Override
	public List<ContentsFileDTO> tAniContentsFileList() throws Exception {
		return contentsMapper.tAniContentsFileList();
	};
	...
	@Override
	public List<ContentsFileDTO> fDramaContentsFileList() throws Exception {
		return contentsMapper.fDramaContentsFileList();
	};
	
	@Override
	public List<ContentsFileDTO> kDramaContentsFileList() throws Exception {
		return contentsMapper.kDramaContentsFileList();
	};
